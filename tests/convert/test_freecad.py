...
from convert.adapters.freecad.format import (
    CAPABILITY_CARRIER_REASONS,
    CAPABILITY_WRITE_TYPE_IDS,
    FORMAT_ID,
    INFO,
    NATIVE_CAPABILITIES,
    SUFFIX,
...
from convert.adapters.freecad.protocol import (
    ADDITIONAL_PART_OBJECT_TYPE_IDS,
    ...
    CONSTRAINT_CARRIER_KINDS,
    CONSTRAINT_COMPOSED_KINDS,
    CONSTRAINT_DIRECT_KINDS,
    ...
    REGISTERED_PART_OBJECT_TYPE_IDS,
...
from tests.interchange.test_document import document as neutral_document
