...
from convert.adapters.solidworks.container.Container import DEFAULT_FILE_ID, DEFAULT_SIGNATURES, SldprtArchive, _template_fields, build_sldprt, signature_triplet
...
_PROVENANCE = _ROOT / "re" / "data" / "SignatureTable.json"
