...
ASSEMBLY = (
    Path(__file__).parents[4] / "examples" / "Random" / "Pistons" / "Piston.SLDASM"
)
CONROD = Path(__file__).parents[4] / "examples" / "Random" / "Pistons" / "Conrod.SLDASM"
PISTON_RING = (
    Path(__file__).parents[4] / "examples" / "Random" / "Pistons" / "Piston_ring.SLDPRT"
)
CATPRODUCT = (
    Path(__file__).parents[4] / "examples" / ".CATProduct" / "Tilton_Set.CATProduct"
)
...
KFreeCadCylCorpus = (
    Path(__file__).parents[4] / ".rescratch" / "fcstd" / "cylinder_r5_h10.FCStd"
)
