...
from convert.adapters.solidworks.core.Topology import BOSS_OPERATION, CUT_OPERATION, FeatureTopology, FULL_REVOLUTION_END, REVOLVE_BOSS_OPERATION, REVOLVE_CUT_OPERATION, REVOLVE_SUPPORTS, SUPPORTED_END_CONDITIONS
