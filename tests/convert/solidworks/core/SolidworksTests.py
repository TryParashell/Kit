...
import convert.adapters.solidworks.core.Adapter as solidworks_adapter
import convert.adapters.solidworks.assembly.Assembly as solidworks_assembly
import convert.adapters.solidworks.core.Display as solidworks_display
import convert.adapters.solidworks.core.Native as solidworks_native
...
from convert.adapters.solidworks.container.Format import ASSEMBLY_FORMAT_ID, ASSEMBLY_SUFFIX, CANONICAL_PLANE_FEATURE_TYPE, CLASS_MARKER, COMPONENT_TREE_STREAM, CONTAINER_VERSIONS, CONTENT_TYPES_STREAM, DIMENSION_SCALAR_HEADERS, DISPLAY_LISTS_STREAM, FEATURES_STREAM, FORMAT_IDS, FORMAT_ID_BY_SUFFIX, INFO, KEYWORDS_STREAM, KIT_DOCUMENT_STREAM, MATES_STREAM_NAME, MATES_STREAM_SUFFIX, OFFICIAL_REFERENCE_PLANE_FEATURE_TYPES, PARTITION_STREAM, PART_FORMAT_ID, PART_SUFFIX, PLANE_FEATURE_TYPES, RELATIONSHIPS_STREAM, RESOLVED_FEATURES_STREAM, SERIALIZED_STRING_MARKER, SOLIDWORKS_STREAM, SOLID_BODY_FEATURE_TYPES, SUFFIX_BY_FORMAT_ID, dimension_scalar_value_offset, is_cad_path, is_component_path
...
SAMPLE = Path(__file__).parents[4] / "examples" / ".SLDPRT" / "example.SLDPRT"
