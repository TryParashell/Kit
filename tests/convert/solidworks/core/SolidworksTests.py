...
# keeps this focused behavior isolated so regressions remain immediately visible
@PytestLib.mark.parametrize(('ItemValue', 'IsCad', 'IsComponent'), (('C:/parts/Part.SLDPRT', True, False), ('C:/parts/Assembly.SLDASM', True, False), ('C:/parts/Part.sldprtx', False, False), ('Rotor@Assembly', False, True), ('Top Plane@Rotor@Assembly', False, False)))
