...
from convert.adapters.solidworks.core.Display import decode_display_lists, decode_tessellation_faces, is_component_path, neutral_meshes

ASSEMBLY = Path(__file__).parents[4] / "examples" / "Random" / "V8_engine.SLDASM"
