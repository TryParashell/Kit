...
from convert.adapters.solidworks.core.Native import _HEADER_OBJECTS, _NativeIdentity, _SOLIDWORKS_CONFIGURATION_FLAGS, _header_payload
...
KFixtureRoot = (
    Path(__file__).resolve().parents[3] / "fixtures" / "solidworks" / "donors"
)
