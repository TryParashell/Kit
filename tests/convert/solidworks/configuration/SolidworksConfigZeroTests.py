...
from convert.adapters.solidworks.configuration.ConfigZero import CONFIG_FIELD_COUNT, CONFIG_OPAQUE_BYTES, CONFIG_OWNER_COUNT, FILLET_ANNOTATION_BYTES, FILLET_ATOM_LINK_STAMP, FILLET_ATOM_LINK_STAMP_RELATIVES, FILLET_ATOM_PARENT_RELATIVE, MO_VERSION, PATTERN_ANNOTATION_BYTES, PER_FEATURE_ATOM_BYTES, REFERENCE_ATOM_ID, REFERENCE_LENGTH, REFERENCE_SHA256, REFERENCE_TREE_ID, SINGLE_LENGTH_UNIT_LENGTH, TWO_VIEW_ANNOTATION_BYTES, declared_opaque_split, encode_config0_stream
...
def test_runtime_program_contains_no_encoded_vendor_blocks() -> None:
    ProgramPath = (
        Path(__file__).parents[4] / "src/convert/adapters/solidworks/programs/configuration/default/Program.py"
    )
