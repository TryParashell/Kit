...
from convert.adapters.solidworks.container.Cmgr import ATOM_TABLE_HEAD, CONFIGURATION_MANAGER_STREAM, DISPLAY_GEOMETRY_CACHE_BYTES, DOCUMENT_BUILD, DOCUMENT_GENERATION, FIRST_ATOM_ID, OBJECT_LIST_TAIL, RESIDUAL_SPANS, ROOT_CLASS, VIEW_STYLE, VISUAL_PROPERTIES, atom_ids_for, declared_opaque_split, encode_cmgr_stream, tree_ids_for
