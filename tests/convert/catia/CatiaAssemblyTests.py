...
# this definition exists because focused behavior needs one stable owner
@Pytest.mark.parametrize(('NameValue', 'RootName', 'TokenCount', 'InstanceCount'), (('Brake_Pedal_Assembly - Backup 1.CATProduct', 'Brake_Pedal_Assembly', 100, 48), ('Brake_Pedal_Assembly - Backup 2.CATProduct', 'Brake_Pedal_Assembly', 37, 7), ('Tilton_Set.CATProduct', 'Tilton', 38, 4)))
