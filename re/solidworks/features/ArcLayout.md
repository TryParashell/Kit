...
`find_arc_fields.py`, `layout_arcs.py`, `diff_sweep.py`, `VerifyLayout.py`, `check_reader.py`.
...
.rescratch/arc/
  ...
  VerifyLayout.py       direction-offset generality check (negative: not a general locator)
