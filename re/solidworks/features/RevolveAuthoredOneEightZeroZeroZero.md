...
the corpus-derived revolve plan in `RevolveDonorSpec.md` §2 option 2. Every number here was
...
`RevolveDonorSpec.md` §3 proposed putting the axis kind in the `support` slot. That is not
