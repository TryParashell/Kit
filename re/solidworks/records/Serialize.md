...
The record is _variable length and driven entirely by its first field_:
...
Function: `sldmodu.dll` `0x4bb9b650`. `moRevEndSpec_c::getType` is the _same machine code_ as
