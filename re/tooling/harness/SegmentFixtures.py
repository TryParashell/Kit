...
from convert.adapters.solidworks.container.Archive import BaseResolution, LayoutTable, MO_VERSION_PREFIX, STREAM_HEADER_SIZE, container_mo_version, resolve_base, verify
...
DEFAULT_LAYOUTS = ROOT / "re" / "data" / "ClassLayouts.json"
