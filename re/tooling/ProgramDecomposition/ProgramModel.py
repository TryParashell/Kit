...
# needed to keep reverse engineering responsibilities isolated and maintainable
KOperationNames = ('StreamPrograms', 'ConfigOps', 'KConfigOps', 'ResolvedOps', 'KResolvedOps', 'AnnotationOps')

# needed to keep reverse engineering responsibilities isolated and maintainable
KSingleStreams = {'ConfigOps': 'Configuration', 'KConfigOps': 'Configuration', 'ResolvedOps': 'ResolvedFeatures', 'KResolvedOps': 'ResolvedFeatures', 'AnnotationOps': 'AnnotationManager'}
