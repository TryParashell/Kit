...
$log = Join-Path $root "logs\dump_extclass.log"
...
& $headless (Join-Path $root "proj_sldmodu") sldmodu `
    ...
    -postScript DumpFunctions.java (Join-Path $root "out\extclass_serialize.c") (Join-Path $repo "re\tooling\ghidra\Specs\ExtclassSpec.txt") 1 300 `
