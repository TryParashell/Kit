...
$log = Join-Path $root "logs\dump_accessors2.log"
...
& $headless (Join-Path $root "proj_sldmodu") sldmodu `
    ...
    -postScript DumpFunctions.java (Join-Path $root "out\sldmodu_accessors2.c") (Join-Path $root "SpecAccessorsTwo.txt") 0 180 `
