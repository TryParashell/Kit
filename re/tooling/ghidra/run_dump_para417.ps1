...
& $headless (Join-Path $root "proj_sldmodu") sldmodu `
    ...
    -postScript DumpFunctions.java (Join-Path $root "out\para417_serialize.c") (Join-Path $repo "re\tooling\ghidra\spec_para417_serialize.txt") 1 300 `
    -postScript DumpFunctions.java (Join-Path $root "out\para417_accessors.c") (Join-Path $repo "re\tooling\ghidra\spec_para417_accessors.txt") 0 120 `
