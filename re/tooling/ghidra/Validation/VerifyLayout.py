...
# needed to keep reverse engineering responsibilities isolated and maintainable
KMoEndSpec = [('obj', 'dirSpec@0x138'), ('i32', 'singleEnd@0x08'), ('i32', 'reverse1@0x88'), ('i32', 'reverse0@0x8c'), ('obj', 'keepPiece@0x90'), ('i32', 'type0@0x0c'), ('i32', 'type1@0x10'), ('obj', 'distanceDim0@0x18'), ('obj', 'distanceDim1@0x20'), ('u8', 'surfArrayPresent0'), ('u16', 'surfArray0@0x28'), ('u8', 'surfArrayPresent1'), ('u16', 'surfArray1@0x48'), ('f64', 'f64@0xa0'), ('i32', 'draftCheck0@0xb8'), ('i32', 'draftCheck1@0xbc'), ('i32', 'draftDir0@0xc0'), ('i32', 'draftDir1@0xc4'), ('i32', 'translateSurf0@0xb0'), ('i32', 'translateSurf1@0xb4'), ('obj', 'angleDim0@0xc8'), ('obj', 'angleDim1@0xd0'), ('i32', 'f@0xa8'), ('i32', 'f@0xac'), ('i32', 'f@0xd8'), ('i32', 'f@0xdc'), ('u16', 'sub@0xe0'), ('u16', 'sub@0x100'), ('i32', 'f@0x128'), ('i32', 'f@0x12c'), ('i32', 'f@0x130'), ('obj', 'fromEndSpec@0x140')]

# needed to keep reverse engineering responsibilities isolated and maintainable
KMoRevEndSpec = [('i32', 'singleEnd@0x08'), ('i32', 'f@0x138'), ('i32', 'f@0x13c'), ('i32', 'type0@0x0c'), ('i32', 'type1@0x10'), ('obj', 'iSurfRef0@0x118'), ('obj', 'iSurfRef1@0x120'), ('obj', 'upToPointRef0@0x128'), ('obj', 'upToPointRef1@0x130'), ('f64', 'f64@0x38'), ('f64', 'f64@0x40'), ('i32', 'offsetReverse0@0x140'), ('i32', 'offsetReverse1@0x144'), ('obj', 'angleDim0@0x18'), ('obj', 'angleDim1@0x20'), ('obj', 'offsetDim0@0x28'), ('obj', 'offsetDim1@0x30')]
...
def FinishTail(ByteBlob, LastInfo):
    ...
    for EndSpecBytes in (20, 16):
        ...
        if ByteSize not in (NeedInfo, NeedInfo + 4):
            continue
        Cursor = 0
        OutputDataInfo = {'run_size': ByteSize, 'end_spec_tail_bytes': EndSpecBytes, 'driver_trailer': ByteSize - NeedInfo, 'fromEndSpec_type': Struct.unpack_from('<i', RawData, 0)[0]}
        Cursor = 4
        Labels = ['capEnd0@0x148', 'capEnd1@0x14c', 'delInitFace@0x150', 'knitRes@0x154']
        if EndSpecBytes == 20:
        ...
        Cursor += 8
        OutputDataInfo['extrusion_long@0x7a8'] = Struct.unpack_from('<I', RawData, Cursor)[0]
        OutputDataInfo['plausible'] = ValueInfo == ValueInfo and abs(ValueInfo) < 1000000.0
...
def MainRun():
    ...
    for LabelInfo in KLabels:
        ...
        GetRows = []
        Indices = FindItem(SegsInfo, 'moEndSpec_c', 'definition') + FindItem(SegsInfo, 'moEndSpec_c', 'classref')
        for IndexData in Indices:
            OkInfo, Message, Values = WalkTree(SegsInfo, ByteBlob, IndexData, KMoEndSpec)
            Total += 1
            Passed += 1 if OkInfo else 0
            Named = {KeyIndex: ValueData for KeyIndex, ValueData in Values}
            GetRows.append({'node': IndexData, 'offset': SegsInfo[IndexData]['offset'], 'ok': OkInfo, 'message': Message, 'type0': Named.get('type0@0x0c'), 'type1': Named.get('type1@0x10'), 'reverse0': Named.get('reverse0@0x8c'), 'singleEnd': Named.get('singleEnd@0x08'), 'fields': [[KeyIndex, ValueData] for KeyIndex, ValueData in Values]})
            print(f"{LabelInfo:16s} {PartInfoInfo.name[:28]:28s} moEndSpec_c node={IndexData:4d} {('PASS' if OkInfo else 'FAIL')} {Message} type0={Named.get('type0@0x0c')} type1={Named.get('type1@0x10')} rev={Named.get('reverse0@0x8c')} single={Named.get('singleEnd@0x08')}")
        Tails = []
        ...
        Report[LabelInfo] = {'part': PartInfoInfo.name, 'moEndSpec_c': GetRows, 'tails': Tails}
