...
description: "Require every repository-working agent to use its own isolated Git worktree and finish with a draft pull request. Use before delegating or starting agent work."
