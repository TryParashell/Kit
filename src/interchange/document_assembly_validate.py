...
from .document_identity import GetIdGroups
...
def GetAssemblyErrs(
    ...
    from .document_component_validate import GetDefLinkErrs, GetDocLinkErrs
    from .document_graph_validate import GetGraphErrors
    from .document_mate_entity_validate import GetMateEntErrs
    from .document_mate_group_validate import GetMateGroups
    from .document_mate_validate import GetMateErrors
    from .document_mesh_validate import GetMeshErrors
