...
NODE_PLAN = (
    ...
    ("definition", "moLengthUserUnits_c", 1, MOLENGTHUSERUNITS_N003_BODY),
    ("classref", "moLengthUserUnits_c", 0, MOLENGTHUSERUNITS_N004_BODY),
    ("null", "", 0, MOLENGTHUSERUNITS_N005_BODY),
    ("definition", "moAngleUserUnits_c", 1, MOANGLEUSERUNITS_N006_BODY),
    ("definition", "moNumberUserUnits_c", 1, MONUMBERUSERUNITS_N007_BODY),
    ("definition", "moDensityUnits_c", 1, MODENSITYUNITS_N008_BODY),
    ("definition", "moFloatNumberUserUnits_c", 1, MOFLOATNUMBERUSERUNITS_N009_BODY),
    ("definition", "moSpringConstantUnits_c", 1, MOSPRINGCONSTANTUNITS_N010_BODY),
    ("definition", "moUnitSysUnits_c", 1, MOUNITSYSUNITS_N011_BODY),
    ("definition", "moForceUnits_c", 1, MOFORCEUNITS_N012_BODY),
    ("definition", "moStressUnits_c", 1, MOSTRESSUNITS_N013_BODY),
    ("definition", "moGravityUnits_c", 1, MOGRAVITYUNITS_N014_BODY),
    ("definition", "moLinearMotorUnits_c", 1, MOLINEARMOTORUNITS_N015_BODY),
    ("definition", "moRotaryMotorUnits_c", 1, MOROTARYMOTORUNITS_N016_BODY),
    ("definition", "moPowerUnits_c", 1, MOPOWERUNITS_N017_BODY),
    ("definition", "moEnergyUnits_c", 1, MOENERGYUNITS_N018_BODY),
    ("definition", "moTimeUnits_c", 1, MOTIMEUNITS_N019_BODY),
    ("definition", "moFrequencyUserUnits_c", 1, MOFREQUENCYUSERUNITS_N020_BODY),
