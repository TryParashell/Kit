...
AnnotationOps = (
    ...
    (280, 16, 43, "string", "*Front"),
    (296, 1, 36, "primitive:uchar", 0),
    (297, 8, 37, "primitive:double", float.fromhex("0x0.0p+0")),
    (305, 8, 38, "primitive:double", float.fromhex("0x0.0p+0")),
    (313, 8, 39, "primitive:double", float.fromhex("0x0.0p+0")),
    (321, 8, 40, "primitive:double", float.fromhex("0x1.0000000000000p+0")),
    (329, 1, 41, "primitive:uchar", 0),
    (330, 1, 36, "primitive:uchar", 0),
    (331, 8, 37, "primitive:double", float.fromhex("0x0.0p+0")),
    (339, 8, 38, "primitive:double", float.fromhex("0x0.0p+0")),
    (347, 8, 39, "primitive:double", float.fromhex("0x0.0p+0")),
    (355, 8, 40, "primitive:double", float.fromhex("0x1.0000000000000p+0")),
    (363, 1, 41, "primitive:uchar", 0),
    (364, 2, 15, "primitive:ushort", 0),
    (366, 4, 16, "primitive:long", -1),
    (370, 8, 17, "primitive:double", float.fromhex("-0x1.0000000000000p+0")),
    (378, 4, 18, "primitive:long", 0),
    (382, 4, 19, "primitive:long", 201),
    (386, 4, 20, "primitive:long", 0),
    (390, 4, 21, "primitive:long", 0),
    (394, 4, 22, "primitive:long", 0),
    (398, 8, 23, "primitive:double", float.fromhex("0x0.0p+0")),
    (406, 4, 24, "primitive:long", 0),
    (410, 4, 25, "primitive:long", 0),
    (414, 4, 26, "primitive:long", 0),
    (418, 4, 4, "primitive:long", 0),
    (422, 2, 42, "null", 0),
    (424, 2, 42, "null", 0),
    (426, 4, 5, "primitive:long", 0),
    (430, 8, 6, "primitive:double", float.fromhex("0x0.0p+0")),
    (438, 2, 42, "null", 0),
    (440, 4, 7, "primitive:long", 0),
    (444, 4, 8, "primitive:long", 1),
    (448, 2, 42, "null", 0),
    (450, 4, 0, "primitive:long", -1),
    (454, 4, 1, "primitive:long", 0),
    (458, 4, 2, "primitive:long", -1),
    (462, 4, 3, "primitive:long", -1),
    (466, 4, 9, "primitive:long", 201),
    (470, 4, 10, "primitive:long", 199),
    (474, 4, 11, "primitive:long", 1),
    (478, 4, 12, "primitive:long", 199),
    (482, 2, 42, "null", 0),
    (484, 4, 13, "primitive:ulong", 0),
    (488, 4, 14, "primitive:long", 0),
    (492, 2, 44, "primitive:ushort", 0),
    (494, 2, 44, "primitive:ushort", 0),
    (496, 2, 44, "primitive:ushort", 0),
    (498, 2, 44, "primitive:ushort", 0),
    (500, 2, 44, "primitive:ushort", 0),
    (502, 2, 44, "primitive:ushort", 0),
    (504, 2, 44, "primitive:ushort", 0),
    (506, 2, 44, "primitive:ushort", 0),
    (508, 2, 42, "null", 0),
    (510, 2, 44, "primitive:ushort", 0),
)
