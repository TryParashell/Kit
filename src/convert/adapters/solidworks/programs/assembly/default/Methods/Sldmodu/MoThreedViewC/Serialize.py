...
KMethodProgram = (
    ...
    {
        "Contents/CMgr": (
            (365, 4, 9208, "primitive:int", 1),
            (369, 4, 9386, "primitive:int", -2147221120),
            (377, 4, 9593, "primitive:ulong", 24),
            (381, 4, 9687, "primitive:ulong", 104),
        ...
        "Contents/Config-0": (
            (2568, 4, 2363, "primitive:long", -1431655766),
            (2572, 4, 2379, "primitive:long", -1145324613),
        ),
