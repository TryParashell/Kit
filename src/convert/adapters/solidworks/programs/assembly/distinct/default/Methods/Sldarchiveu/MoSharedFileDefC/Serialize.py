...
KMethodProgram: MethodProgram = (
    KOwnerSites,
    {
        ...
        "Contents/Config-0": (
            ...
            (1299, 2, 1006, "primitive:ushort", 3),
            (1301, 1, 1028, "primitive:uchar", 0),
            (1318, 1, 1519, "primitive:uchar", 0),
        ),
        "Contents/Config-0-ModelHeader": (
            (2215, 2, 1006, "primitive:ushort", 2),
            (2217, 1, 1028, "primitive:uchar", 0),
            (2234, 1, 1519, "primitive:uchar", 0),
            (2490, 2, 1006, "primitive:ushort", 2),
            (2492, 1, 1028, "primitive:uchar", 0),
            (2509, 1, 1519, "primitive:uchar", 0),
            (2705, 2, 1006, "primitive:ushort", 3),
            (2707, 1, 1028, "primitive:uchar", 0),
            (2724, 1, 1519, "primitive:uchar", 0),
        ),
    },
)
