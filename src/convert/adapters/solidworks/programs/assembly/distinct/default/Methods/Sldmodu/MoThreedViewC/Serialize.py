...
KMethodProgram: MethodProgram = (
    ...
    {
        "Contents/CMgr": (
            (365, 4, 9208, "primitive:int", 2),
            (369, 4, 9386, "primitive:int", -2147221120),
            (377, 4, 9593, "primitive:ulong", 25),
            (381, 4, 9687, "primitive:ulong", 107),
            ...
            (2172, 4, 22843, "primitive:ulong", 203),
        ),
        "Contents/Config-0": (
            (3254, 4, 2363, "primitive:long", -1431655766),
            (3258, 4, 2379, "primitive:long", -1145324613),
        ),
