...
KMethodProgram = (
    ...
    {
        "Contents/CMgr": (
            (365, 4, 9208, "primitive:int", 3),
            (369, 4, 9386, "primitive:int", -2147221120),
            (377, 4, 9593, "primitive:ulong", 26),
            (381, 4, 9687, "primitive:ulong", 110),
            ...
            (1727, 4, 22843, "primitive:ulong", 203),
            (2188, 4, 22843, "primitive:ulong", 203),
            (2612, 4, 22843, "primitive:ulong", 203),
        ),
        "Contents/Config-0": (
            (3880, 4, 2363, "primitive:long", -1431655766),
            (3884, 4, 2379, "primitive:long", -1145324613),
        ),
