...
KMethodProgram: MethodProgram = (
    KOwnerSites,
    {
        "AnnotationManager": (
            ...
            (296, 1, 35, "primitive:uchar", 1),
            (369, 8, 67, "primitive:double", float.fromhex("0x0.0p+0")),
            (377, 8, 80, "primitive:double", float.fromhex("0x0.0p+0")),
            (385, 8, 93, "primitive:double", float.fromhex("0x0.0p+0")),
            (393, 8, 106, "primitive:double", float.fromhex("0x1.0000000000000p+0")),
            (401, 1, 120, "primitive:uchar", 0),
            (402, 1, 35, "primitive:uchar", 0),
            (403, 8, 67, "primitive:double", float.fromhex("0x0.0p+0")),
            (411, 8, 80, "primitive:double", float.fromhex("0x0.0p+0")),
            (419, 8, 93, "primitive:double", float.fromhex("0x0.0p+0")),
            (427, 8, 106, "primitive:double", float.fromhex("0x1.0000000000000p+0")),
            (435, 1, 120, "primitive:uchar", 0),
        ),
    },
)
