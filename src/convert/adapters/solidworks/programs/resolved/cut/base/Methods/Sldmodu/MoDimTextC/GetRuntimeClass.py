...
KMethodProgram: MethodProgram = (
    KOwnerSites,
    {
        "ResolvedFeatures": (
            ...
            (15170, 4, 4801, "primitive:long", 18),
            (15176, 4, 4848, "primitive:long", 0),
            (15204, 8, 5200, "primitive:double", float.fromhex("0x1.0000000000000p+0")),
            (15212, 4, 5225, "primitive:long", 0),
            (15216, 4, 5763, "primitive:long", 0),
            (15220, 4, 5810, "primitive:long", 0),
            (15224, 4, 6314, "primitive:long", 0),
            (
                15228,
                8,
                6342,
            ...
            (15244, 4, 6383, "primitive:long", 0),
            (15250, 4, 6586, "primitive:long", 0),
            (15254, 4, 6611, "primitive:long", 0),
            (15258, 4, 6636, "primitive:long", 0),
            (15262, 8, 6652, "primitive:double", float.fromhex("0x1.0000000000000p+0")),
            (15270, 4, 6668, "primitive:long", 0),
        ),
    },
)
