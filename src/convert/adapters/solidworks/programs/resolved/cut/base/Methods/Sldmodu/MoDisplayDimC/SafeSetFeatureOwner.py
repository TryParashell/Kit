...
KMethodProgram: MethodProgram = (
    KOwnerSites,
    {
        "ResolvedFeatures": (
            ...
            (13261, 4, 4724, "primitive:ulong", 1),
            (13265, 4, 4744, "primitive:long", 1),
            (13349, 4, 1931, "primitive:long", 3),
            (13354, 4, 2342, "primitive:long", 0),
            (13364, 4, 3319, "primitive:ulong", 100000),
        ),
    },
)
