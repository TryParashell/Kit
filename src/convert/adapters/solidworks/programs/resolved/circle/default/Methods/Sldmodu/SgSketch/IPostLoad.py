...
KMethodProgram: MethodProgram = (
    KOwnerSites,
    {
        "ResolvedFeatures": (
            ...
            (6977, 2, 1727, "primitive:ushort", 1),
            (7176, 2, 2487, "primitive:ushort", 0),
            (7178, 2, 3321, "primitive:ushort", 0),
            (7180, 2, 4785, "primitive:ushort", 0),
            (7182, 2, 5374, "primitive:ushort", 0),
            (7184, 2, 5913, "primitive:ushort", 1),
            (7293, 2, 6441, "primitive:ushort", 0),
            (7295, 2, 7044, "primitive:ushort", 0),
            (7297, 2, 7640, "primitive:ushort", 0),
            (7299, 2, 8090, "primitive:ushort", 0),
            (7301, 2, 8542, "primitive:ushort", 0),
            (7303, 2, 9002, "primitive:ushort", 0),
            (8917, 2, 9998, "primitive:ushort", 0),
            (8919, 2, 10423, "primitive:ushort", 0),
        ),
    },
)
