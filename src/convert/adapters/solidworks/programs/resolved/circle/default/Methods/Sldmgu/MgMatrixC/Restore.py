...
KMethodProgram: MethodProgram = (
    KOwnerSites,
    {
        "ResolvedFeatures": (
            ...
            (11500, 8, 90, "primitive:double", float.fromhex("0x1.0000000000000p+0")),
            (11508, 8, 103, "primitive:double", float.fromhex("0x0.0p+0")),
            (11516, 8, 116, "primitive:double", float.fromhex("0x0.0p+0")),
            (11524, 8, 130, "primitive:double", float.fromhex("0x0.0p+0")),
            (11532, 8, 144, "primitive:double", float.fromhex("0x0.0p+0")),
            (11540, 8, 158, "primitive:double", float.fromhex("0x1.0000000000000p+0")),
            (11548, 8, 172, "primitive:double", float.fromhex("0x0.0p+0")),
            (11556, 8, 186, "primitive:double", float.fromhex("-0x1.0000000000000p+0")),
            (11564, 8, 200, "primitive:double", float.fromhex("0x0.0p+0")),
        ),
    },
)
