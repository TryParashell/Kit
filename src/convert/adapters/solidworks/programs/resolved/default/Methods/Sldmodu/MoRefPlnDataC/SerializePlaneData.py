...
KMethodProgram = (
    KOwnerSites,
    {
        "ResolvedFeatures": (
            ...
            (4262, 8, 812, "primitive:double", float.fromhex("0x1.6872b020c49bap-8")),
            (4270, 8, 812, "primitive:double", float.fromhex("-0x1.6872b020c49bap-8")),
            ...
            (4816, 8, 812, "primitive:double", float.fromhex("0x1.6872b020c49bap-8")),
            (4824, 8, 812, "primitive:double", float.fromhex("-0x1.6872b020c49bap-8")),
