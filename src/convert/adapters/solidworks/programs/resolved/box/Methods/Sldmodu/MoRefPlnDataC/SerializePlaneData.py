...
KMethodProgram: MethodProgram = (
    KOwnerSites,
    {
        "ResolvedFeatures": (
            ...
            (3680, 8, 812, "primitive:double", float.fromhex("0x1.6872b020c49bap-7")),
            (3688, 8, 812, "primitive:double", float.fromhex("-0x1.6872b020c49bap-7")),
            (3696, 8, 812, "primitive:double", float.fromhex("0x1.0e5604189374cp-7")),
            (3704, 8, 812, "primitive:double", float.fromhex("-0x1.0e5604189374cp-7")),
            ...
            (4246, 8, 812, "primitive:double", float.fromhex("0x1.6872b020c49bap-7")),
            (4254, 8, 812, "primitive:double", float.fromhex("-0x1.6872b020c49bap-7")),
            (4262, 8, 812, "primitive:double", float.fromhex("0x1.b089a02752546p-8")),
            (4270, 8, 812, "primitive:double", float.fromhex("-0x1.b089a02752546p-8")),
            ...
            (4816, 8, 812, "primitive:double", float.fromhex("0x1.b089a02752546p-8")),
            (4824, 8, 812, "primitive:double", float.fromhex("-0x1.b089a02752546p-8")),
            (4832, 8, 812, "primitive:double", float.fromhex("0x1.0e5604189374cp-7")),
            (4840, 8, 812, "primitive:double", float.fromhex("-0x1.0e5604189374cp-7")),
