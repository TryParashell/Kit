...
KMethodProgram: MethodProgram = (
    KOwnerSites,
    {
        "ResolvedFeatures": (
            ...
            (10263, 8, 90, "primitive:double", float.fromhex("0x1.0000000000000p+0")),
            (10271, 8, 103, "primitive:double", float.fromhex("0x0.0p+0")),
            (10279, 8, 116, "primitive:double", float.fromhex("0x0.0p+0")),
            (10287, 8, 130, "primitive:double", float.fromhex("0x0.0p+0")),
            (10295, 8, 144, "primitive:double", float.fromhex("0x0.0p+0")),
            (10303, 8, 158, "primitive:double", float.fromhex("0x1.0000000000000p+0")),
            (10311, 8, 172, "primitive:double", float.fromhex("0x0.0p+0")),
            (10319, 8, 186, "primitive:double", float.fromhex("-0x1.0000000000000p+0")),
            (10327, 8, 200, "primitive:double", float.fromhex("0x0.0p+0")),
            (14620, 8, 90, "primitive:double", float.fromhex("0x0.0p+0")),
            (14628, 8, 103, "primitive:double", float.fromhex("0x1.6a09e667f3bcdp-1")),
            (14636, 8, 116, "primitive:double", float.fromhex("0x1.6a09e667f3bcdp-1")),
            (14644, 8, 130, "primitive:double", float.fromhex("0x0.0p+0")),
            (14652, 8, 144, "primitive:double", float.fromhex("0x1.6a09e667f3bcdp-1")),
            (14660, 8, 158, "primitive:double", float.fromhex("-0x1.6a09e667f3bcdp-1")),
            (14668, 8, 172, "primitive:double", float.fromhex("-0x1.0000000000000p+0")),
            (14676, 8, 186, "primitive:double", float.fromhex("0x0.0p+0")),
            (14684, 8, 200, "primitive:double", float.fromhex("0x0.0p+0")),
        ),
    },
)
