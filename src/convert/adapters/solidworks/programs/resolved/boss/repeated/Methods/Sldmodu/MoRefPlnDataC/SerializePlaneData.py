...
KMethodProgram: MethodProgram = (
    KOwnerSites,
    {
        "ResolvedFeatures": (
            ...
            (3918, 8, 812, "primitive:double", float.fromhex("0x1.0e5604189374cp-5")),
            (3926, 8, 812, "primitive:double", float.fromhex("-0x1.0e5604189374cp-5")),
            (3934, 8, 812, "primitive:double", float.fromhex("0x1.6872b020c49bap-6")),
            (3942, 8, 812, "primitive:double", float.fromhex("-0x1.6872b020c49bap-6")),
            ...
            (4484, 8, 812, "primitive:double", float.fromhex("0x1.0e5604189374cp-5")),
            (4492, 8, 812, "primitive:double", float.fromhex("-0x1.0e5604189374cp-5")),
            (4500, 8, 812, "primitive:double", float.fromhex("0x1.c28f5c28f5c2ap-7")),
            (4508, 8, 812, "primitive:double", float.fromhex("-0x1.c28f5c28f5c2ap-7")),
            ...
            (5054, 8, 812, "primitive:double", float.fromhex("0x1.c28f5c28f5c2ap-7")),
            (5062, 8, 812, "primitive:double", float.fromhex("-0x1.c28f5c28f5c2ap-7")),
            (5070, 8, 812, "primitive:double", float.fromhex("0x1.6872b020c49bap-6")),
            (5078, 8, 812, "primitive:double", float.fromhex("-0x1.6872b020c49bap-6")),
