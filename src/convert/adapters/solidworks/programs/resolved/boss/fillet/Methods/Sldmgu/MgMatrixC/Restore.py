...
KMethodProgram: MethodProgram = (
    KOwnerSites,
    {
        "ResolvedFeatures": (
            ...
            (12830, 8, 90, "primitive:double", float.fromhex("-0x1.0000000000000p+0")),
            (12838, 8, 103, "primitive:double", float.fromhex("0x0.0p+0")),
            (12846, 8, 116, "primitive:double", float.fromhex("0x0.0p+0")),
            (12854, 8, 130, "primitive:double", float.fromhex("0x0.0p+0")),
            (12862, 8, 144, "primitive:double", float.fromhex("0x1.0000000000000p+0")),
            (12870, 8, 158, "primitive:double", float.fromhex("0x0.0p+0")),
            (12878, 8, 172, "primitive:double", float.fromhex("0x0.0p+0")),
            (12886, 8, 186, "primitive:double", float.fromhex("0x0.0p+0")),
            (12894, 8, 200, "primitive:double", float.fromhex("-0x1.0000000000000p+0")),
        ),
    },
)
