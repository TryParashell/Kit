...
KMethodProgram = (
    KOwnerSites,
    {
        "ResolvedFeatures": (
            ...
            (16386, 4, 4801, "primitive:long", 13),
            (16392, 4, 4848, "primitive:long", 0),
            (16420, 8, 5200, "primitive:double", float.fromhex("0x1.0000000000000p+0")),
            (16428, 4, 5225, "primitive:long", 0),
            (16432, 4, 5763, "primitive:long", 0),
            (16436, 4, 5810, "primitive:long", 0),
            (16440, 4, 6314, "primitive:long", 0),
            (
                16444,
                8,
                6342,
            ...
            (16460, 4, 6383, "primitive:long", 0),
            (16466, 4, 6586, "primitive:long", 0),
            (16470, 4, 6611, "primitive:long", 0),
            (16474, 4, 6636, "primitive:long", 0),
            (16478, 8, 6652, "primitive:double", float.fromhex("0x1.0000000000000p+0")),
            (16486, 4, 6668, "primitive:long", 0),
        ),
    },
)
