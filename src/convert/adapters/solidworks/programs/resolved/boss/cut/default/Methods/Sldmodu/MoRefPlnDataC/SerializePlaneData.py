...
KMethodProgram = (
    KOwnerSites,
    {
        "ResolvedFeatures": (
            ...
            (3918, 8, 812, "primitive:double", float.fromhex("0x1.9e83e425aee63p-6")),
            (3926, 8, 812, "primitive:double", float.fromhex("-0x1.9e83e425aee63p-6")),
            (3934, 8, 812, "primitive:double", float.fromhex("0x1.d495182a9930dp-7")),
            (3942, 8, 812, "primitive:double", float.fromhex("-0x1.d495182a9930dp-7")),
            ...
            (4484, 8, 812, "primitive:double", float.fromhex("0x1.9e83e425aee63p-6")),
            (4492, 8, 812, "primitive:double", float.fromhex("-0x1.9e83e425aee63p-6")),
            (4500, 8, 812, "primitive:double", float.fromhex("0x1.b089a02752546p-8")),
            (4508, 8, 812, "primitive:double", float.fromhex("-0x1.b089a02752546p-8")),
            ...
            (5054, 8, 812, "primitive:double", float.fromhex("0x1.b089a02752546p-8")),
            (5062, 8, 812, "primitive:double", float.fromhex("-0x1.b089a02752546p-8")),
            (5070, 8, 812, "primitive:double", float.fromhex("0x1.d495182a9930dp-7")),
            (5078, 8, 812, "primitive:double", float.fromhex("-0x1.d495182a9930dp-7")),
