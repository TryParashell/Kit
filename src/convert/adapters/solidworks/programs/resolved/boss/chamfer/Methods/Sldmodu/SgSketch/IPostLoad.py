...
KMethodProgram = (
    KOwnerSites,
    {
        "ResolvedFeatures": (
            ...
            (7564, 2, 5913, "primitive:ushort", 0),
            (7566, 2, 6441, "primitive:ushort", 0),
            (7568, 2, 7044, "primitive:ushort", 0),
            (7570, 2, 7640, "primitive:ushort", 0),
            (7572, 2, 8090, "primitive:ushort", 0),
            (7574, 2, 8542, "primitive:ushort", 0),
            (7576, 2, 9002, "primitive:ushort", 0),
            (7582, 2, 9998, "primitive:ushort", 0),
            (7584, 2, 10423, "primitive:ushort", 0),
        ),
    },
)
