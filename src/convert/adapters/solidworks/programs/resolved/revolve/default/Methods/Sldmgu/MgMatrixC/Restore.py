...
KMethodProgram: MethodProgram = (
    KOwnerSites,
    {
        "ResolvedFeatures": (
            ...
            (11188, 8, 90, "primitive:double", float.fromhex("0x1.0000000000000p+0")),
            (11196, 8, 103, "primitive:double", float.fromhex("0x0.0p+0")),
            (11204, 8, 116, "primitive:double", float.fromhex("-0x0.0p+0")),
            (11212, 8, 130, "primitive:double", float.fromhex("0x0.0p+0")),
            (11220, 8, 144, "primitive:double", float.fromhex("0x0.0p+0")),
            (11228, 8, 158, "primitive:double", float.fromhex("0x1.0000000000000p+0")),
            (11236, 8, 172, "primitive:double", float.fromhex("0x0.0p+0")),
            (11244, 8, 186, "primitive:double", float.fromhex("-0x1.0000000000000p+0")),
            (11252, 8, 200, "primitive:double", float.fromhex("0x0.0p+0")),
        ),
    },
)
