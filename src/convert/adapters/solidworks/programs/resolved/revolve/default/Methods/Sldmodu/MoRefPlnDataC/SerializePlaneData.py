...
KMethodProgram = (
    KOwnerSites,
    {
        "ResolvedFeatures": (
            ...
            (3680, 8, 812, "primitive:double", float.fromhex("0x1.32617c1bda512p-6")),
            (3688, 8, 812, "primitive:double", float.fromhex("-0x1.32617c1bda512p-6")),
            (3696, 8, 812, "primitive:double", float.fromhex("0x1.d495182a9930ap-8")),
            (3704, 8, 812, "primitive:double", float.fromhex("-0x1.d495182a9930ap-8")),
            ...
            (4246, 8, 812, "primitive:double", float.fromhex("0x1.32617c1bda512p-6")),
            (4254, 8, 812, "primitive:double", float.fromhex("-0x1.32617c1bda512p-6")),
            (4262, 8, 812, "primitive:double", float.fromhex("0x1.32617c1bda512p-6")),
            (4270, 8, 812, "primitive:double", float.fromhex("-0x1.32617c1bda512p-6")),
            ...
            (4816, 8, 812, "primitive:double", float.fromhex("0x1.32617c1bda512p-6")),
            (4824, 8, 812, "primitive:double", float.fromhex("-0x1.32617c1bda512p-6")),
            (4832, 8, 812, "primitive:double", float.fromhex("0x1.d495182a9930ap-8")),
            (4840, 8, 812, "primitive:double", float.fromhex("-0x1.d495182a9930ap-8")),
