...
KMethodProgram = (
    KOwnerSites,
    {
        "ResolvedFeatures": (
            ...
            (10227, 4, 3177, "primitive:long", 0),
            (10231, 4, 3190, "primitive:long", 0),
            (10241, 4, 3307, "primitive:long", 0),
            (10492, 2, 16845, "primitive:ushort", 1),
            (10496, 4, 17007, "primitive:long", 0),
            (10500, 4, 17062, "primitive:long", 104),
            (10504, 2, 17130, "primitive:ushort", 0),
            (10506, 2, 17256, "primitive:ushort", 0),
            (10508, 4, 17382, "primitive:long", 0),
            (10512, 4, 17599, "primitive:long", 0),
            (10516, 4, 17717, "primitive:long", -12345),
            (10520, 4, 17736, "primitive:long", -12345),
            (10524, 4, 17797, "primitive:long", -12345),
            (10528, 4, 17953, "primitive:long", 0),
            (10532, 4, 18072, "primitive:long", 18000),
            (10536, 4, 18195, "primitive:long", 0),
            (10540, 4, 18208, "primitive:long", 0),
            (10544, 4, 18380, "primitive:long", 0),
            (10548, 4, 18442, "primitive:long", -1),
        ),
    },
)
