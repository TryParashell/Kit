...
KMethodProgram: MethodProgram = (
    KOwnerSites,
    {
        "ResolvedFeatures": (
            ...
            (9396, 4, 100, "primitive:long", 1),
            (9404, 4, 100, "primitive:long", 0),
            (9422, 4, 100, "primitive:long", 0),
            (9995, 4, 100, "primitive:long", 0),
            (10527, 4, 100, "primitive:long", 0),
            (10678, 4, 100, "primitive:long", 0),
            (11703, 4, 100, "primitive:long", 0),
            (11707, 4, 100, "primitive:long", 0),
        ),
    },
)
