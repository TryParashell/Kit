...
KMethodProgram: MethodProgram = (
    KOwnerSites,
    {
        "ResolvedFeatures": (
            ...
            (8492, 2, 1727, "primitive:ushort", 0),
            (8494, 2, 2487, "primitive:ushort", 0),
            (8496, 2, 3321, "primitive:ushort", 0),
            (8498, 2, 4785, "primitive:ushort", 0),
            (8500, 2, 5374, "primitive:ushort", 1),
            (8557, 2, 5913, "primitive:ushort", 1),
            (8666, 2, 6441, "primitive:ushort", 0),
            (8668, 2, 7044, "primitive:ushort", 0),
            (8670, 2, 7640, "primitive:ushort", 0),
            (8672, 2, 8090, "primitive:ushort", 0),
            (8674, 2, 8542, "primitive:ushort", 0),
            (8676, 2, 9002, "primitive:ushort", 0),
            (8682, 2, 9998, "primitive:ushort", 0),
            (8684, 2, 10423, "primitive:ushort", 0),
        ),
    },
)
