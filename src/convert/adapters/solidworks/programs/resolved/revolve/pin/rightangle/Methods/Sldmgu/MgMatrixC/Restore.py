...
KMethodProgram = (
    KOwnerSites,
    {
        "ResolvedFeatures": (
            ...
            (11590, 8, 90, "primitive:double", float.fromhex("-0x1.0000000000000p+0")),
            (11598, 8, 103, "primitive:double", float.fromhex("0x0.0p+0")),
            (11606, 8, 116, "primitive:double", float.fromhex("0x0.0p+0")),
            (11614, 8, 130, "primitive:double", float.fromhex("0x0.0p+0")),
            (11622, 8, 144, "primitive:double", float.fromhex("-0x1.0000000000000p+0")),
            (11630, 8, 158, "primitive:double", float.fromhex("0x0.0p+0")),
            (11638, 8, 172, "primitive:double", float.fromhex("0x0.0p+0")),
            (11646, 8, 186, "primitive:double", float.fromhex("0x0.0p+0")),
            (11654, 8, 200, "primitive:double", float.fromhex("0x1.0000000000000p+0")),
        ),
    },
)
