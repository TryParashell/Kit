...
from convert.adapters.solidworks.programs.configuration.revolve.pin.default.Program import EncodeProgram as EncodePinConfig, KConfigOps, KFieldOwners, KReferenceLength
