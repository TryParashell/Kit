...
NON_FEATURE_OBJECT_TYPE_IDS = PART_CONTAINER_TYPE_IDS | {SKETCH_TYPE_ID}
...
GEOMETRY_TYPES = (
    ...
    GeometryType("Part::GeomArcOfEllipse", GeometryKind.ARC_ELLIPSE),
    GeometryType("Part::GeomHyperbola", GeometryKind.HYPERBOLA),
    GeometryType("Part::GeomArcOfHyperbola", GeometryKind.ARC_HYPERBOLA),
    GeometryType("Part::GeomParabola", GeometryKind.PARABOLA),
    GeometryType("Part::GeomArcOfParabola", GeometryKind.ARC_PARABOLA),
...
GEOMETRY_WRITE_TYPE_IDS = MappingProxyType(
    {
        ...
        GeometryKind.ARC_ELLIPSE: frozenset(),
        GeometryKind.HYPERBOLA: frozenset(),
        GeometryKind.ARC_HYPERBOLA: frozenset(),
        GeometryKind.PARABOLA: frozenset(),
        GeometryKind.ARC_PARABOLA: frozenset(),
