...
from tools.fcstd_output import PrintReport
from tools.fcstd_summary import BuildSummary
from tools.fcstd_worker import RunWorker
...
def MainRun() -> int:
    ...
    from tools.fcstd_isolate import AuditIsolated
